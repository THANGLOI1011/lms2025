...
const CourseDetails = () => {
  ...
  useEffect(() => {
    if (userData && userData.enrollCourse && courseData) {
    ...
    <>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                  ...
                  <div className='flex'>
                    {[...Array(5)].map((_,i) => (<img key={i} src={i < Math.floor(caculateRating(courseData))  ?  assets.star : assets.star_blank} alt='' className='w-3.5 h-3.5' />))}
                  </div>
      ...
      {/* right column */}
      <div className='max-w-[424px] z-10 shadow-[0_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] '>
        {
        ...
        <div className='p-5'>
            <div className='flex items-center gap-2'>
             <img className='w-3.5' src={assets.time_left_clock_icon} alt="time left clock icon" /> 
              <p className='text-red-500'><span className='font-medium'>5 day </span>left at this price! </p>
            </div>                    
          ...
          >
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-[15px] list-disc text-gray-500 '>
                ...
                <li>Quizzer to test your knowledge.</li>
